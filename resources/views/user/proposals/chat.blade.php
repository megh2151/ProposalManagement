                ...
                <div class="row mx-0">
                    <div class="col-md-12 chat-right-content">
                        ...
                        <form class="px-5 pb-3" id="message-form">
                            ...
                            <button data-from_id="{{auth()->user()->id}}" data-to_id="{{$to_id}}" data-proposal_id="{{$proposal->id}}" class="float-right btn btn-primary" id="send-button"><i class="mdi mdi-send"></i></button>
                        </form>
                    </div>
                </div>
            </div>
                ...
                if (response && response.length > 0) {
                    $.each(response, function(i, message) {
                        ...
                        var html = '<div class="chat chat-message chat-left" id="' + message.id + '">' +
                                '<img class="rounded-circle ml-3" src="' + message.from.avatar + '" alt="Image">' +
                                '<div class="chat-body">' +
                                '<p class="message">' + message.message + '</p>' +
